...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  // Generate verification token using the instance method
  ...
  try {
    ...
    await sendEmail({
      email: newUser.email,
      subject: 'Email Verification - Livestock Management System',
      message
    });
...
exports.verifyEmail = catchAsync(async (req, res, next) => {
  ...
  // If token has not expired, and there is user, mark as verified
  if (!user) {
